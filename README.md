# Linear-Block-Code
# Aim:
 To Perform the Linear-Block-Code in the given Message signal using python.
# Tools Required:
...
```
# Output:
![image](https://github.com/user-attachments/assets/e5f448d9-585b-435e-8849-c825ccf270ed)
![image](https://github.com/user-attachments/assets/c319cdbb-4b52-47e1-9058-ef79d2f05973)
